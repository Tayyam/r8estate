...
exports.sendEmail = functions.https.onCall(async (data) => {
    try {
        ...
        if (!to) {
            throw new functions.https.HttpsError('invalid-argument', 'Missing required field: to');
        }
        let emailHtml = html;
        ...
        if (templateType && !html) {
            switch (templateType) {
                case 'otp':
                    if (!(templateData === null || templateData === void 0 ? void 0 : templateData.otp) || !(templateData === null || templateData === void 0 ? void 0 : templateData.companyName)) {
                        throw new functions.https.HttpsError('invalid-argument', 'Missing required template data for OTP email');
                    }
                    emailHtml = getOTPEmailTemplate(templateData.otp, templateData.companyName);
                    break;
                case 'password-reset':
                    if (!(templateData === null || templateData === void 0 ? void 0 : templateData.email)) {
        ...
        if (!emailHtml) {
            throw new functions.https.HttpsError('invalid-argument', 'No HTML content or valid template provided');
        }
...
function getOTPEmailTemplate(otp, companyName) {
