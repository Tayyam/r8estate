...
exports.checkBusinessEmailVerification = exports.verifySupervisor = exports.claimProcess = void 0;
...
exports.verifySupervisor = functions.https.onRequest(async (req, res) => {
    try {
...
exports.checkBusinessEmailVerification = functions.https.onCall(async (data, context) => {
    try {
        ...
        const claimRequestDoc = await claimRequestRef.get();
        if (!claimRequestDoc.exists) {
            throw new functions.https.HttpsError('not-found', 'Claim request not found');
        }
        ...
        throw new functions.https.HttpsError('internal', error.message || 'Failed to check business email verification', error);
    }
});
