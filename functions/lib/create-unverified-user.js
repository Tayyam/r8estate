...
exports.createUnverifiedUser = void 0;
...
exports.createUnverifiedUser = functions.https.onCall(async (data, context) => {
    try {
      ...
      `,
        ...
        // Note: We're NOT creating a user document in Firestore yet
        // It will be created after email verification
        return {
            success: true,
...
//# sourceMappingURL=create-unverified-user.js.map